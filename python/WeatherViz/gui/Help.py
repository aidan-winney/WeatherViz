...
class Help(QWidget):
    ...
    def initUI(self):
        ...
        instructionText3.setText(
            ...
            "∙ Query results will automatically save to the tab and a local database\n         "
            "◦ Saved results will be loaded in when you open the program again\n         "
            "◦ The results will be overwritten by querying again in the same tab\n    "
            "∙ Click + to open a new query tab\n        "
            "◦ New query tab will show result of the last tab viewed\n        "
            "◦ Switch back to other tabs to see previous query results\n    "
