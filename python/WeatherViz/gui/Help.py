...
class Help(QWidget):
    ...
    def initUI(self):
        ...
        instructionText3.setText(
            ...
            "∙ Query results will automatically save to the tab and will be loaded in when you open the program again\n         "
            "◦ The results will be overwritten by querying again in the same tab\n    "
            "∙ Click + to open a new query tab, you can switch back to other tabs to see previous query results\n        "
            "◦ New query tab will show result of previous tab viewed so information can be used when deciding new query\n    "
            "∙ Click the trash symbol to delete the current tab and the query from the database\n\n"
